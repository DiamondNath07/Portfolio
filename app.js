...
const projectList = [
  {
    ...
    projectImg: './NewImgs/big-screen1.png',
    text: ' This is a web application conference page with an about page section. This project populate data to page dynamicallly using map and hides some content using splice method. Hidden contents are displayed by using the click button. This project is built with javascript,HTML&CSS',
    livecode: 'diamondnath07.github.io/Web_Summit/',
    sourcecode: 'https://github.com/DiamondNath07/Web_Summit.git.git',
  },
  {
    id: 2,
